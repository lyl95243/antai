...
$(function () {
    ...
    // console.log(esID);
       ...
       // 请求头、头部信信息
       Ajax(
           "/smarteye/api/search/security/httpDetails?esID="+esID+"&index="+indexL+"&type="+type+"",
           "get",
           "json",
           "",
           false,
           function (result) {
               ...
               $.each(reqHeaders,function(key){
                   ...
                   var reqTableCon="<tr><th style='width: 22%'>"+key+"</th><td>"+reqHeaders[key]+"</td></tr>";
               ...
               $.each(resHeaders,function(key){
                   ...
                   var resTableCon="<tr><th style='width: 22%'>"+key+"</th><td>"+resHeaders[key]+"</td></tr>";
                   // var tr=document.createElement("tr");
       ...
       // 请求体
       Ajax(
           "/smarteye/api/search/security/httpReqBody?esID="+esID+"&index="+indexL+"&type="+type+"",
           "get",
           "json",
           "",
           false,
       ...
       // 相应体
       Ajax(
           "/smarteye/api/search/security/httpResBody?esID="+esID+"&index="+indexL+"&type="+type+"",
           "get",
           "json",
           "",
           false,
